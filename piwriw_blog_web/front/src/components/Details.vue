<template>
  <div>
    ...
    <div v-html='artInfo.html_content' class='content ma-5 pa-3 text-justify'></div>
...
export default {
  ...
  methods: {
    ...
    // 发送评论
    async pushComment() {
      const { data: res } = await this.$http.post('commentfront/add', {
